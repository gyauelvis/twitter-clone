<template>
    <section class="nav">
        <div class="nav-container">
            <a href="#" alt="" class="nav__item nav-profile" @click.prevent="store.toggleSidebar">
                <img :src="'profile.jpg'" alt="" class="nav-profile__img">
            </a>
            <a href="#" alt="" class="nav__item nav-brand-icon">
            ...
            <a href="#" alt="" class="nav__item nav-settings">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
                    <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
                        stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0"
                        font-family="none" font-weight="none" font-size="none" text-anchor="none"
        ...
        <div class="nav__post-filter">
            ...
            <a href="#" class="nav__post-filter__item  roboto-regular"
                ...
                @click.prevent="active1 = true; active0 = false">Following</a>
        </div>
    </section>
</template>
