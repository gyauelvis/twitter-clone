            ...
            <div class="feed-card__tweet">
                <div class="tweet-info">
                    ...
                    <div class="tweet__content">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia blanditiis ducimus doloribus labore
                        ...
                        <div class="action-icons">
                            <a href="#" class="comment">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M8 13.5H16M8 8.5H12" stroke="#71767b" stroke-width="1.5" stroke-linecap="round"
